...
export const ProductServiceService = {
    ...
    updateProduct: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(UpdateProductRequest.encode(value).finish()),
        requestDeserialize: (value) => UpdateProductRequest.decode(value),
        responseSerialize: (value) => Buffer.from(Product.encode(value).finish()),
        responseDeserialize: (value) => Product.decode(value),
    },
    deleteProduct: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(DeleteProductRequest.encode(value).finish()),
        requestDeserialize: (value) => DeleteProductRequest.decode(value),
...
export const ProductServiceClient = makeGenericClientConstructor(ProductServiceService, "product_service.ProductService");
