...
export const InvalidateRequest = {
    ...
    create(base) {
        return InvalidateRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseInvalidateRequest();
        message.key = object.key ?? "";
...
export const InvalidateResponse = {
    ...
    create(base) {
        return InvalidateResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseInvalidateResponse();
        message.message = object.message ?? "";
...
export const CacheServiceService = {
    getCache: {
        ...
        responseSerialize: (value) => Buffer.from(Product.encode(value).finish()),
        responseDeserialize: (value) => Product.decode(value),
    },
    setCache: {
        path: "/cache_service.CacheService/SetCache",
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(SetRequest.encode(value).finish()),
        requestDeserialize: (value) => SetRequest.decode(value),
        responseSerialize: (value) => Buffer.from(SetResponse.encode(value).finish()),
        responseDeserialize: (value) => SetResponse.decode(value),
    },
    invalidateCache: {
        path: "/cache_service.CacheService/InvalidateCache",
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(InvalidateRequest.encode(value).finish()),
        requestDeserialize: (value) => InvalidateRequest.decode(value),
        responseSerialize: (value) => Buffer.from(InvalidateResponse.encode(value).finish()),
        responseDeserialize: (value) => InvalidateResponse.decode(value),
    },
};
export const CacheServiceClient = makeGenericClientConstructor(CacheServiceService, "cache_service.CacheService");
